...
The aim of this project (due to intrinsic nature of the web) is not to be constrained by boundaries and contribute across conventional social and political boundaries as much as possible, in that vein I will be trying to incorporate as many languages as possible and would encourage folks to either create an issue making known if there is anything that can be added/fixed to increase access or to create a PR with the desired changes. I am starting this project alone but with hope that I will find others who share the same love.
