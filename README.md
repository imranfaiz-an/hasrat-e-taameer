...
<p align="center" style="font-family: 'Noto Nastaliq Urdu', 'Nastaliq', serif; font-size: 1.2em; line-height: 2.2;">
...
The aim of this project (due to intrinsic nature of the web) is not to be constrained by boundaries and contribute across conventional social and political boundaries as much as possible, in that vein I will be trying to incorporate as many language as possible and would encourage folks to either create an issue making known if there is anything that can be added/fixed to increase access or to create a PR with the desired changes. I am starting this as a alone but with hope that I will find others who share the same love and a desire to contribute.

**New changes coming soon - in the meanwhile please reach out to me directly if you are looking to contribute in any way shape or form, you can email [here](mailto:imranfaiz@uchicago.edu)**
